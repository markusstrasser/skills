...
- **[2026-08-11] codex exec: --full-auto REMOVED from current CLI (exit 2 usage error, 2026-08-09); working invocation: codex exec -s workspace-write -C <dir> -m gpt-5.6-{sol,luna} -c model_reasoning_effort="med" — 15+ dispatches verified (genomics kernel slices)**
