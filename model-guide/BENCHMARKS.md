...
| Benchmark | Claude Opus 4.6 | Claude Sonnet 4.6 | GPT-5.4 | Gemini 3.1 Pro | Kimi K2.5 | Measures |
|-----------|:---:|:---:|:---:|:---:|:---:|----------|
...
| **SimpleQA** | **72%** | -- | ~72% | **72.1%** | 36.9% | Factual accuracy |
...
| Factual accuracy | Tie: Claude / Gemini / GPT-5.4 | ~72% SimpleQA | +35pp over Kimi |
| Math | GPT-5.4 / Kimi K2.5 | 98% MATH | +5pp over Claude |
