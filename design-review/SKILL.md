...
**Loop mode:** When invoked via `/loop`, use quick mode. Append to existing daily file. Focus on delta — new sessions since last run. Check for `/tmp/design_review_last_run` timestamp.
