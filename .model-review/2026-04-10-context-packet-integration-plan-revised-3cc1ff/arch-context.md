...
### 6. Shared preamble API

Add a first-class helper instead of rebuilding this logic in each builder:
...
This is a shared helper, not implicit side work inside a selector module.
...
- unify live and batch source assembly and manifest logic
...
- prompt output remains equivalent enough to avoid silent behavior drift
...
- golden or normalized-equivalence tests for overview prompt payloads
