...
| Adaptive Thinking | `https://platform.claude.com/docs/en/build-with-claude/adaptive-thinking.md` | "Extract adaptive thinking setup, effort levels (including xhigh), thinking.display defaults, and Claude Opus 4.8 usage examples" |
