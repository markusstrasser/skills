<!-- VENDORED 2026-08-19 from github.com/AminBlg/SimpleEnglish (MIT, v1.2.0),
     skills/simple-english/SKILL.md body. Paraphrase of ASD-STE100 Issue 9.
     Kept as a REFERENCE, not installed as a global skill: skills-index budget was
     at 96% of the ~8K ceiling and its description claims the "de-slop" trigger.
     Refresh: re-clone upstream and re-copy the body. -->
